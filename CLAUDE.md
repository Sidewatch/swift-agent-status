...
What a terminal is doing — idle, running, agent working, needs you, done — derived from the foreground process (name, path, argv) and the screen the agent drew; and what it said — the compiler and linter diagnostics in its scrollback, as facts with a path, a line and the toolchain's own label.
